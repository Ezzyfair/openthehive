      ...
      <section ref={topRef} className="max-w-[640px] mx-auto px-6 pt-28 pb-20">
        ...
        <div className="bg-hive-bg2 border border-hive-border rounded-[10px] p-6">
          {[
            ...
            { label: 'Bank Account (via Stripe Connect)', field: 'eth_wallet', ph: 'Linked after signup — Stripe Connect setup takes 3 minutes', type: 'text' } /* ⚑ FLAGGED: eth_wallet column wiring → Stripe Connect is Nikita/Francis code work */,
