          ...
          <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-6" onClick={() => setShowTerms(false)}>
            <div className="bg-hive-bg2 border border-hive-border rounded-[12px] max-w-[680px] w-full max-h-[85vh] overflow-y-auto p-8" onClick={e => e.stopPropagation()}>
              ...
              <div className="text-[12px] text-hive-muted leading-[1.8] space-y-3">
                <p><strong className="text-hive-text">1. Your Earnings & Wallet.</strong> 20% of referred subscriptions at L1; 10% at L2 (bees your L1 recruits bring in). Paid monthly in USDC to your self-custody wallet on Base. Commissions pay only while the recruited member's subscription stays active — no recruitment bounties. Rates may change with 30 days written notice to your registered email.</p>
