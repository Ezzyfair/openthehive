  ...
  return (
    <div style={{ minHeight:'100vh', background:'#F2EDE4', padding:'120px 48px 80px', maxWidth:800, margin:'0 auto', fontFamily:'Inter,sans-serif' }}>
      ...
      <div style={{ background:'rgba(201,168,76,0.08)', border:'1px solid rgba(201,168,76,0.3)', padding:32, fontFamily:'Inter,sans-serif', fontSize:14, color:'#5A4535', lineHeight:1.8 }}>
        ...
        <p style={{ marginBottom:16 }}><strong>Cascade commissions</strong> are paid monthly via Stripe Connect to your linked bank account. L1 rate: 20% of referred member subscriptions. L2 rate: 10% of subscriptions brought in by your L1 referrals. Commissions pay only while the referred member maintains an active paid subscription, and only while your own membership is active — no recruitment bounties, no payment for the act of inviting. Rates may change with 30 days written notice to your registered email address.</p>
